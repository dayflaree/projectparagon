...
if (CLIENT) then
    ...
    function PLUGIN:HUDPaint()
        ...
        if (ix.option.Get("observerESP", true) and client:GetMoveType() == MOVETYPE_NOCLIP and
            ...
            for _, v in ipairs(GetNetVar("buttonPositions", {})) do
                ...
                ix.util.DrawText("Level " .. v[2], x, y - size, ColorAlpha(color, alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, nil, alpha)
            end
        end
    end
