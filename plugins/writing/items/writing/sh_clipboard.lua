...
ITEM.name = "Clipboard"
ITEM.description = "A simple wooden clipboard and notepad, %s."
ITEM.model = Model("models/myproject/props/clipboard.mdl")
ITEM.width = 1
ITEM.height = 1
...
function ITEM:GetDescription()
    return self:GetData("owner", 0) == 0
        and string.format(self.description, "it's fresh but dirty")
