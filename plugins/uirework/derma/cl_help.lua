...
function PANEL:Init()
	...
	self.idlePanel.Paint = function(_, width, height)
		Schema:DrawFullOutlinedPanel(_, width, height)
	...
	self.categoryPanel:SetWide(ScrW() * 0.25)
...
function PANEL:AddCategory(name)
	...
	button:DockMargin(ScreenScale(2), name == "credits" and 0 or ScreenScale(2), ScreenScale(2), name == "credits" and ScreenScale(2) or 0)
