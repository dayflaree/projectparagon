...
function PANEL:Init()
    ...
    self.textEntry:SetFont("Font-Elements-ScreenScale12")
...
function PANEL:Init()
    ...
    self.setting:Dock(RIGHT)
    self.setting:SetFont("Font-Elements-ScreenScale12")
...
function PANEL:Init()
    ...
    self.text:Dock(LEFT)
    self.text:SetFont("Font-Elements-ScreenScale12")
...
function PANEL:AddCategory(name)
    ...
    if (!IsValid(panel)) then
        ...
        panel:SetText(name)
        panel:Dock(TOP)
        panel:DockMargin(0, ScreenScale(8), 0, 0)
