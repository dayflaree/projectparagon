...
vgui.Register("ixChatboxTabButton", PANEL, "ixMenuButton")
...
function PANEL:Init()
	...
	self.buttons:SetTall(ScreenScale(14))
	self.buttons:Dock(TOP)
	self.buttons:DockPadding(ScreenScale(2), ScreenScale(2), ScreenScale(2), ScreenScale(2))
