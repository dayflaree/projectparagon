...
function PANEL:Init()
	...
	controlsPanel:SetTall(ScreenScale(10))

	self.create = controlsPanel:Add("ixMenuButton")
	self.create:SetText(L("create"))
	self.create:SetFont("Font-Elements-ScreenScale8")
	...
	local uncheckAll = controlsPanel:Add("ixMenuButton")
	uncheckAll:SetText(L("uncheckAll"))
	uncheckAll:SetFont("Font-Elements-ScreenScale8")
	...
	local checkAll = controlsPanel:Add("ixMenuButton")
	checkAll:SetText(L("checkAll"))
	checkAll:SetFont("Font-Elements-ScreenScale8")
