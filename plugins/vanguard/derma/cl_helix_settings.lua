...
local panelMap = {
    [ix.type.bool] = "ixVanguardSettingsRowBool",
    [ix.type.array] = "ixVanguardSettingsRowArray",
    [ix.type.string] = "ixVanguardSettingsRowString",
    [ix.type.number] = "ixVanguardSettingsRowNumber",
    [ix.type.color] = "ixVanguardSettingsRowColor"
}
...
function PANEL:OpenPicker()
    ...
    self.picker = vgui.Create("ixVanguardSettingsRowColorPicker", self)
    self.picker:Attach(self)
    self.picker:SetValue(self.color)

    self.picker.OnValueChanged = function(panel)
        if (!IsValid(panel)) then return end
        if (!IsValid(self)) then panel:Remove() return end
...
vgui.Register("ixVanguardSettingsRowColor", PANEL, "ixVanguardSettingsRow")
...
vgui.Register("ixVanguardSettingsRowColorPicker", PANEL, "EditablePanel")

// number setting
PANEL = {}

function PANEL:Init()
    self.setting = self:Add("ixVanguardNumSlider")
...
function PANEL:OpenEntry()
    ...
    self.entry = vgui.Create("ixVanguardSettingsRowNumberEntry", self)
...
vgui.Register("ixVanguardSettingsRowNumber", PANEL, "ixVanguardSettingsRow")
...
function PANEL:Init()
    ...
    self.textEntry = self:Add("ixVanguardTextEntry")
...
vgui.Register("ixVanguardSettingsRowNumberEntry", PANEL, "EditablePanel")

// string setting
PANEL = {}

function PANEL:Init()
    self.setting = self:Add("ixVanguardTextEntry")
    self.setting:Dock(RIGHT)
...
vgui.Register("ixVanguardSettingsRowString", PANEL, "ixVanguardSettingsRow")

// bool setting
PANEL = {}

function PANEL:Init()
    self.setting = self:Add("ixVanguardCheckBox")
    self.setting:Dock(RIGHT)
...
vgui.Register("ixVanguardSettingsRowBool", PANEL, "ixVanguardSettingsRow")
...
vgui.Register("ixVanguardSettingsRowArray", PANEL, "ixVanguardSettingsRow")
...
vgui.Register("ixVanguardSettingsRow", PANEL, "EditablePanel")
...
function PANEL:GetRowPanelName(type)
    return panelMap[type] or "ixVanguardSettingsRow"
end
