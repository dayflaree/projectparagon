...
vgui.Register("ixVanguardSubpanel", PANEL, "EditablePanel")
...
function PANEL:AddSubpanel(name)
    ...
    local panel = BaseClass.Add(self, "ixVanguardSubpanel")
...
vgui.Register("ixVanguardSubpanelParent", PANEL, "EditablePanel")
