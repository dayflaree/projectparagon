...
vgui.Register("ixVanguardTextEntry", PANEL, "DTextEntry")
...
vgui.Register("ixVanguardCategoryPanel", PANEL, "EditablePanel")
...
vgui.Register("ixVanguardSegmentedProgress", PANEL, "Panel")
...
vgui.Register("ixVanguardListRow", PANEL, "Panel")
...
vgui.Register("ixVanguardCheckBox", PANEL, "EditablePanel")
...
vgui.Register("ixVanguardNumSlider", PANEL, "Panel")
...
vgui.Register("ixVanguardSlider", PANEL, "EditablePanel")
...
// status menu.
//     local label = vgui.Create("ixVanguardLabel")
...
vgui.Register("ixVanguardLabel", PANEL, "Panel")

// text entry with icon
DEFINE_BASECLASS("ixVanguardTextEntry")
PANEL = {}
...
vgui.Register("ixVanguardIconTextEntry", PANEL, "ixTextEntry")
