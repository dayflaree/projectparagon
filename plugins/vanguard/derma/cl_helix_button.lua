...
vgui.Register("ixVanguardMenuButton", PANEL, "DButton")

// selection menu button
DEFINE_BASECLASS("ixVanguardMenuButton")
PANEL = {}
...
function PANEL:AddSection(name)
    if (!IsValid(self.sectionPanel)) then
        ...
        self.sectionPanel = vgui.Create("ixVanguardMenuSelectionList", self:GetParent())
...
vgui.Register("ixVanguardMenuSelectionButton", PANEL, "ixVanguardMenuButton")
...
function PANEL:AddButton(name, buttonList)
    assert(IsValid(self.parent), "attempted to add button to ixVanguardMenuSelectionList without a ParentButton")
    assert(buttonList ~= nil, "attempted to add button to ixVanguardMenuSelectionList without a buttonList")

    local button = self:Add("ixVanguardMenuSelectionButton")
...
vgui.Register("ixVanguardMenuSelectionList", PANEL, "Panel")