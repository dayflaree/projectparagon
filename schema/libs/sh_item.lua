            ...
            ITEM.functions.drop = ITEM.functions.drop or {
                ...
                OnRun = function(item)
                    ...
                    if (!bSuccess and isstring(error)) then
                        ...
                        local path, level, pitch, volume = hook.Run("GetItemDropSound", item) or "projectparagon/sfx/Interact/PickItem2.ogg"
            ...
            ITEM.functions.take = ITEM.functions.take or {
                ...
                OnRun = function(item)
                    ...
                    if (!bSuccess) then
                        ...
                        local path, level, pitch, volume = hook.Run("GetItemPickupSound", item) or "projectparagon/sfx/Interact/PickItem2.ogg"
                        client:EmitSound(path, level, pitch, volume)
