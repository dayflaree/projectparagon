...
function PANEL:Init()
	self.text = ""
	self.paddingTop = ScreenScale(14)
...
function PANEL:Paint(width, height)
	...
	if ( height >= width ) then
		Schema:DrawFullOutlinedPanel(self, width, height)
	else
		Schema:DrawOutlinedPanel(self, width, height)
	end
	draw.DrawText(self.text, "Font-Elements-Bold-ScreenScale14", 8, 4, self.color or ix.config.Get("color"), TEXT_ALIGN_LEFT)
end
...
function PANEL:Init()
	...
	self.label:SetFont("Font-Elements-ScreenScale10")
	...
	self.text:SetFont("Font-Elements-ScreenScale10")
...
function PANEL:Init()
	...
	self.font = "Font-Elements-ScreenScale12"
	self.animationTime = 0.5
	self.bChecked = false
	self.labelPadding = 8
...
function PANEL:Init()
	...
	surface.SetFont("Font-Elements-ScreenScale12")
	...
	self.label:SetContentAlignment(5)
	self.label:SetFont("Font-Elements-ScreenScale12")
