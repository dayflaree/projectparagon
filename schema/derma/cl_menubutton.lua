...
function PANEL:Init()
    self:SetFont("Font-Elements-ScreenScale14")
    ...
    self.padding = {4, 4, 4, 4} -- left, top, right, bottom
...
function PANEL:Paint(width, height)
    ...
    if ( self:IsHovered() ) then
        ...
        surface.SetDrawColor(ColorAlpha(self.backgroundColor, 50))
...
function PANEL:AddButton(name, buttonList)
    ...
    button:SetFont("Font-Elements-ScreenScale12")
